...
import 'package:foodie/components/my__cart_tile.dart';
      ...
      return Scaffold(
        ...
        body: Column(
          children: [
            ...
            // Button to pay
            MyButton(onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const PaymentPage())), text: 'Go to checkout'),
